...
int DirectXInit(HWND hWnd)
{
	...
	D3DXCreateFont(p_Device, 18, 0, 0, 0, false, DEFAULT_CHARSET, OUT_CHARACTER_PRECIS, DEFAULT_QUALITY, DEFAULT_PITCH, "Comic Sans MS", &pFontSmall);
...
int Render()
{
	...
	{
		//text with shadow
		//DrawShadowString("test", 5, 0, 240, 240, 250, pFontSmall);
		
		//text without shadow
		DrawString("hey there", 25, 15, 255, 255, 255, pFontSmall);
